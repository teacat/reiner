...
func (s *SubQuery) Table(tableName ...string) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.Table(tableName...)
	return
}
...
func (s *SubQuery) Get(columns ...string) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder, _ = s.builder.Get(columns...)
	return
}
...
func (s *SubQuery) Limit(from int, count ...int) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.Limit(from, count...)
	return
}
...
func (s *SubQuery) OrderBy(column string, args ...interface{}) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.OrderBy(column, args...)
	return
}
...
func (s *SubQuery) GroupBy(columns ...string) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.GroupBy(columns...)
	return
}
...
func (s *SubQuery) RawQuery(query string, values ...interface{}) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder, _ = s.builder.RawQuery(query, values...)
	return
}
...
func (s *SubQuery) Where(args ...interface{}) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.Where(args...)
	return
}
...
func (s *SubQuery) OrWhere(args ...interface{}) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.OrWhere(args...)
	return
}
...
func (s *SubQuery) Having(args ...interface{}) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.Having(args...)
	return
}
...
func (s *SubQuery) OrHaving(args ...interface{}) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.OrHaving(args...)
	return
}
...
func (s *SubQuery) LeftJoin(table interface{}, condition string) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.LeftJoin(table, condition)
	return
}
...
func (s *SubQuery) RightJoin(table interface{}, condition string) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.RightJoin(table, condition)
	return
}
...
func (s *SubQuery) InnerJoin(table interface{}, condition string) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.InnerJoin(table, condition)
	return
}
...
func (s *SubQuery) NaturalJoin(table interface{}, condition string) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.NaturalJoin(table, condition)
	return
}
...
func (s *SubQuery) JoinWhere(table interface{}, args ...interface{}) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.JoinWhere(table, args...)
	return
}
...
func (s *SubQuery) JoinOrWhere(table interface{}, args ...interface{}) (subQuery *SubQuery) {
	subQuery = s.clone()
	subQuery.builder = s.builder.JoinOrWhere(table, args...)
	return
}
